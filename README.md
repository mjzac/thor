...
```
git clone --depth=1 https://github.com/mjzac/thor.git
```
...
npm install
```
- Start your Postgres server (you'll probably want another command prompt / use `postgres app` in Mac)
...
| **src/models**           | Models define Typeorm schemas that will be used in storing and retrieving data from Postgres  |
| **src/public**           | Static assets that will be used client side                                                   |
| **src/routes**           | Routes to be used in the express application.                                                   |
